...
export const startLeadScrapeRadius = (pincode, radiusKm, category, maxResults, country) =>
  call("startLeadScrapeRadius", { pincode, radiusKm, category, maxResults, country })
export const startAdvancedSearch = (payload) => call("startAdvancedSearch", payload)
// payload: { searchMode, category, cities, pincode, radiusKm, maxResults, country }

export const getAdvancedSearchQuota = () => call("getAdvancedSearchQuota")
...
export const deleteAllPersonalizedMails = () => call("deleteAllPersonalizedMails")